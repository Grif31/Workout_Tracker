...
const createStyles = (colors: Colors) => StyleSheet.create({
  ...
  weekNavLabel: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, flex: 1, justifyContent: 'center' },
  ...
  deltaRow: { flexDirection: 'row', alignItems: 'center', gap: 2, marginTop: spacing.xs },
  deltaText: { fontSize: typography.fontSize.xs, fontWeight: '700' },
  ...
  dayLabel: { fontSize: typography.fontSize.xs, color: colors.textSecondary, fontWeight: '600' },
  ...
  pieCenterLabel: { fontSize: typography.fontSize.xs, color: colors.textSecondary, maxWidth: 76, textAlign: 'center' },
  pieLegend: { flex: 1, gap: spacing.xs },
  legendRow: {
    flexDirection: 'row', alignItems: 'center', gap: spacing.sm,
    paddingVertical: spacing.xs, paddingHorizontal: 6, borderRadius: 8,
  },
  ...
  topValueRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, flexShrink: 0 },
  prInfo: { flex: 1 },
